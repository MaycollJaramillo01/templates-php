...
<main id="main-content" class="section section-muted">
  <div class="container stack">
    <header data-anim="from-bottom">
      ...
      <p class="text-muted">A look at our recent <?php echo htmlspecialchars($ActiveIndustry); ?> milestones.</p>
    </header>
    <div class="grid grid-3" aria-label="Gallery grid">
      <?php foreach ($Gallery as $index => $item): ?>
        <figure class="card" style="padding:0; overflow:hidden;" data-anim="zoom" data-anim-delay="<?php echo $index * 60; ?>">
          ...
          <figcaption style="padding:var(--spacing-3);">Project <?php echo htmlspecialchars($index + 1); ?> &mdash; <?php echo htmlspecialchars($item['alt']); ?></figcaption>
        </figure>
      <?php endforeach; ?>
    </div>
  </div>
